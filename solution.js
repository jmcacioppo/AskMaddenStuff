...
$(".ask").click(function() {
	...
	if($(".question").val() == false && check1 == true) {
		...
		if($(".question").val().search("married") || $(".question").val().search("marry")
			...
			if(x >= 0 && x < 10) {
				$(".play").append('<img src = "img/ILeft37Pwr.PNG"/>');
			}
			else if(x >= 10 && x < 15) {
				$(".play").append('<img src = "img/IRight24FakeGoPass.PNG"/>');
			}
			else if(x >= 15 && x < 20) {
				$(".play").append('<img src = "img/IRight33Dive.PNG"/>');
			}
			else if(x >= 20 && x < 25) {
				$(".play").append('<img src = "img/IRightSplit31Fake24Cross.PNG"/>');
			}
			else if(x >= 25 && x < 30) {
				$(".play").append('<img src = "img/Shotgun860_861.PNG"/>');
			}
			else if(x >= 30 && x < 35) {
				$(".play").append('<img src = "img/ShotgunBlue897GunPass.PNG"/>');
			}
			else if(x >= 35 && x < 40) {
				$(".play").append('<img src = "img/ShotgunRed896Run.PNG"/>');
			}
			else if(x >= 40 && x < 45) {
				$(".play").append('<img src = "img/ShotgunRed898GunPass.PNG"/>');
			}
			else if(x >= 45 && x < 50) {
				$(".play").append('<img src = "img/TFormLeftFlankerPass.PNG"/>');
			}
			else if(x >= 50 && x < 55) {
				$(".play").append('<img src = "img/TFormLeftPitchTEReverse.PNG"/>');
			}
			else if(x >= 55 && x < 60) {
				$(".play").append('<img src = "img/TFormRightFakeBootPass.PNG"/>');
			}
			else if(x >= 60 && x < 65) {
				$(".play").append('<img src = "img/TFormRightFakePitch.PNG"/>');
			}
			else if(x >= 65 && x < 70) {
				$(".play").append('<img src = "img/Wing121Jet.PNG"/>');
			}
			else if(x >= 70 && x < 75) {
				$(".play").append('<img src = "img/Wing121Toss.PNG"/>');
			}
			else if(x >= 75 && x < 80) {
				$(".play").append('<img src = "img/Wing182Counter.PNG"/>');
			}
			else if(x >= 80 && x <= 100) {
				$(".play").append('<img src = "img/WingWedge144CTXXDive.PNG"/>');
			}
		}
		...
		//OFFENSE
			...
			if(x >= 0 && x < 25) {
				$(".play").append('<img src = "img/34OddMarlinExchange.PNG"/>');
			}
			else if(x >= 25 && x < 50) {
				$(".play").append('<img src = "img/34QueensDeep.PNG"/>');
			}
			else if(x >= 50 && x < 75) {
				$(".play").append('<img src = "img/34SHT_Pinch.PNG"/>');
			}
			else if(x >= 75 && x <= 100) {
				$(".play").append('<img src = "img/34UnderPirate.PNG"/>');
			}
		} else $(".play").append('<img src = "img/HailMary.png"/>');
